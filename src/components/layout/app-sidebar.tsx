...
const mainNav = [
  ...
  { href: "/dashboard/defenses", label: "My Defenses", icon: Shield },
    ...
    >
      <div className="flex h-16 items-center gap-2.5 border-b border-white/10 px-6">
        ...
        <div>
          ...
          <p className="text-[10px] text-sidebar-foreground/60">ParSU Goa</p>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 p-4">
        <div className="rounded-xl bg-white/10 p-3">
          <p className="text-xs font-medium text-white">Defense Season</p>
